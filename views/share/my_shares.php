...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .card { background: #fff; border-radius: 8px; border: 1px solid #eef2f6; overflow: hidden; }
        ...
        td { padding: 10px 16px; border-bottom: 1px solid #f0f4f9; font-size: 13px; }
        tr:last-child td { border-bottom: none; }
        tr:hover td { background: #fafbfc; }
        .empty { text-align: center; padding: 48px; color: #8b98a9; font-size: 13px; }
        .btn-sm { background: transparent; border: 1px solid #e2e8ef; color: #5b6778; padding: 4px 10px; border-radius: 4px; font-size: 12px; cursor: pointer; transition: all 0.15s; }
        ...
        @media (max-width: 768px) { th:nth-child(3), td:nth-child(3), th:nth-child(6), td:nth-child(6) { display: none; } }
    </style>
</head>
<body>
<div class="header">
...
<div class="content">
    <div class="card">
        <div class="title"><i class="fas fa-share-alt" style="color:#2d8cff"></i> 我的分享</div>
        <?php if (empty($shares)): ?>
...
function cancelShare(id) {
    ...
    apiPost('/api/share/cancel', { id: id }, function() { location.reload(); });
}
</script>
</body>
</html>
